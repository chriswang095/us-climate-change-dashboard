...
File naming:
For files downloaded from online sources, please follow the naming conventions below to ensure the python scripts run.
  1. GHG Emissions: raw_emissions_STATE.csv
  2. Vehicle Registrations: raw_registration_YEAR.csv
